...
from pages.filters_search.Coderworkspace_filter import FilterDefinition
...
class HIMWorkspaceForAuditFilterPage(HIMWorkspaceUnassignedEpisodesFilterPage):
    ...
    FILTERS = {
        **HIMWorkspaceUnassignedEpisodesFilterPage.FILTERS,
        "auditors": FilterDefinition("Auditors", HIMWorkspaceUnassignedEpisodesFilterPage.DYNAMIC_OPTION, "multi_select"),
    }
    DEFAULT_FILTERS = [
        "episode_identifier",
        "mrn",
